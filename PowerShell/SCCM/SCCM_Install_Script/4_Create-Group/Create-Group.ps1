...
$domains = Get-Content E:\AdminTools\SCCM_Script\SCCM_Install_Script\4_Create-Group\Domains.txt
...
$missing | Out-File "E:\AdminTools\SCCM_Script\SCCM_Install_Script\4_Create-Group\Output-MissingDomains.txt"
