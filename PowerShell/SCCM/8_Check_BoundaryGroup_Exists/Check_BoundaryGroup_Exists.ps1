...
Send-MailMessage -Attachments $outfile -To "hs-sysadmin-windows-offshore@mydomain.net" -Subject "SCCM Boundary Checked" -From "sccm@mydomain.net" -SmtpServer "mail-2.mydomain.net"
